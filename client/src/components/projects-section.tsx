...
function ProjectCard({ title, description, technologies, canvasId, canvasColor }: ProjectCardProps) {
  return (
    <Card className="bg-card border border-border rounded-xl overflow-hidden hover:border-primary/50 transition-all duration-300 transform hover:scale-105">
      ...
      <CardContent className="p-6">
        ...
        <button className="text-primary hover:text-primary/80 font-medium" data-testid={`link-project-${canvasId}`}>
          View Project →
        </button>
      </CardContent>
    </Card>
